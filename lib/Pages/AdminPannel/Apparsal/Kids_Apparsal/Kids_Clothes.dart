...
import 'package:myntra/Pages/AdminPannel/Apparsal/Kids_Apparsal/Add_Kids_Cothes.dart';
...
class Kids_Clothes extends StatefulWidget {
  const Kids_Clothes({super.key});

  @override
  State<Kids_Clothes> createState() => _Kids_ClothesState();
}

class _Kids_ClothesState extends State<Kids_Clothes> {

  Future<List<QueryDocumentSnapshot<Map<String, dynamic>>>> getData() async {
    FirebaseFirestore firebaseFirestore = FirebaseFirestore.instance;
    QuerySnapshot<Map<String, dynamic>> data =
    await firebaseFirestore.collection("kidsclothes").get();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,MaterialPageRoute(builder: (context) => Add_Kids_Clothes(),));
          },
