...
import 'Kids_Clothes.dart';



class Add_Kids_Clothes extends StatefulWidget {
  const Add_Kids_Clothes({Key? key}) : super(key: key);

  @override
  State<Add_Kids_Clothes> createState() => _Add_Kids_ClothesState();
}

class _Add_Kids_ClothesState extends State<Add_Kids_Clothes> {
  ...
  Future<void> addProduct() async {
    ...
    await firebaseFirestore.collection("kidsclothes").doc(id).set({
      "image": url,
      "Name": Name.text,
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Kids_Clothes(),));
  }
