...
import 'Add_Woman_Clothes.dart';


class Woman_Clothes extends StatefulWidget {
  const Woman_Clothes({super.key});

  @override
  State<Woman_Clothes> createState() => _Woman_ClothesState();
}

class _Woman_ClothesState extends State<Woman_Clothes> {

  Future<List<QueryDocumentSnapshot<Map<String, dynamic>>>> getData() async {
    FirebaseFirestore firebaseFirestore = FirebaseFirestore.instance;
    QuerySnapshot<Map<String, dynamic>> data =
    await firebaseFirestore.collection("womanclothes").get();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Woman Clothes"),
        ),
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,MaterialPageRoute(builder: (context) => Add_Woman_Clothes(),));
          },
