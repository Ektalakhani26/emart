...
class Add_Man_Clothes extends StatefulWidget {
  const Add_Man_Clothes({Key? key}) : super(key: key);

  @override
  State<Add_Man_Clothes> createState() => _Add_Man_ClothesState();
}

class _Add_Man_ClothesState extends State<Add_Man_Clothes> {
  ...
  Future<void> addProduct() async {
    ...
    await firebaseFirestore.collection("manclothes").doc(id).set({
      "image": url,
      "Name": Name.text,
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Man_Clothes(),));
  }
