...
class Man_Clothes extends StatefulWidget {
  const Man_Clothes({super.key});

  @override
  State<Man_Clothes> createState() => _Man_ClothesState();
}

class _Man_ClothesState extends State<Man_Clothes> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Man Clothes"),
        ),
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,MaterialPageRoute(builder: (context) => Add_Man_Clothes(),));
          },
