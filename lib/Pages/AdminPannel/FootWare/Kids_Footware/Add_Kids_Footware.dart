...
import 'Kids_Footware.dart';



class Add_Kids_Footware extends StatefulWidget {
  const Add_Kids_Footware({Key? key}) : super(key: key);

  @override
  State<Add_Kids_Footware> createState() => _Add_Kids_FootwareState();
}

class _Add_Kids_FootwareState extends State<Add_Kids_Footware> {
  ...
  Future<void> addProduct() async {
    ...
    String id = "Kids${DateTime.now().millisecondsSinceEpoch}";
    await firebaseFirestore.collection("footwarek").doc(id).set({
      "image": url,
      "Name": Name.text,
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Kids_Footware(),));
  }
