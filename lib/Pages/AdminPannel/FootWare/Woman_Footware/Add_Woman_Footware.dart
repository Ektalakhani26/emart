...
import 'Woman_Footware.dart';


class Add_Woman_Footware extends StatefulWidget {
  const Add_Woman_Footware({Key? key}) : super(key: key);

  @override
  State<Add_Woman_Footware> createState() => _Add_Woman_FootwareState();
}

class _Add_Woman_FootwareState extends State<Add_Woman_Footware> {
  ...
  Future<void> addProduct() async {
    ...
    await firebaseFirestore.collection("footwarew").doc(id).set({
      "image": url,
      "Name": Name.text,
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Woman_Footware(),));
  }
