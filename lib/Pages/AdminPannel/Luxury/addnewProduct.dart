...
class _AddProductState extends State<AddProduct> {
  ...
  Future<void> addProduct() async {
    ...
    String id = "luxury${DateTime.now().millisecondsSinceEpoch}";
    await firebaseFirestore.collection("luxury").doc(id).set({
      "image": url,
      "Name": Name.text,
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Luxury(),));
  }
